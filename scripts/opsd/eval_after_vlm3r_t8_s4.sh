#!/usr/bin/env bash
# After VLM-3R T8/S4 MV-OPSD exits, merge the latest complete FSDP actor
# and run full VSI boxed last-line (HF/lmms-eval).
set -euo pipefail
...
HF_DIR="$PROJECT_ROOT/output/20260915_spatialstack_mvopsd_vlm3r_t8_s4_global_step_${latest_n}_hf"
